...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		// Add private r.getCat method
		try {
			getCatMethod = RentACatBuggy.class.getDeclaredMethod("getCat", int.class);
